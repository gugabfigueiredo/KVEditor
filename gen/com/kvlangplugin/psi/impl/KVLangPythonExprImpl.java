...
public class KVLangPythonExprImpl extends ASTWrapperPsiElement implements KVLangPythonExpr {

  public KVLangPythonExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KVLangVisitor visitor) {
    visitor.visitPythonExpr(this);
  }
